...
export const SearchSortPanel = ({ isLinear, handlerSort }: SearchSortSanelProps): JSX.Element => {
    ...
    <S.WrapperPanel>
      ...
      <S.RightBlock>
        <S.WrapperChangeViewCards>
          <ButtonForCardsTiled isActive={!isLinear} />
          <ButtonForCardsList isActive={isLinear} />
        </S.WrapperChangeViewCards>
      </S.RightBlock>
